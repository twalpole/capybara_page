...
describe CapybaraPage::Page do
  ...
  it 'should be able to set a url matcher against it' do
    class PageToSetUrlMatcherAgainst < CapybaraPage::Page
      set_url_matcher(/bob/)
    end
  ...
  it 'should raise an exception if displayed? is called before the matcher has been set' do
    class PageWithNoMatcher < CapybaraPage::Page; end
    expect { PageWithNoMatcher.new.displayed? }.to raise_error CapybaraPage::NoUrlMatcherForPage
  end

  it 'should allow calls to displayed? if the url matcher has been set' do
    class PageWithUrlMatcher < CapybaraPage::Page
      set_url_matcher(/bob/)
    end
  ...
  describe 'with a bogus URL matcher' do
    class PageWithBogusFullUrlMatcher < CapybaraPage::Page
    ...
    specify '#url_matches raises InvalidUrlMatcher' do
      expect { page.url_matches }
        .to raise_error(CapybaraPage::InvalidUrlMatcher)
  ...
  describe 'with a full string URL matcher' do
    class PageWithStringFullUrlMatcher < CapybaraPage::Page
  ...
  context 'with a minimal URL matcher' do
    class PageWithStringMinimalUrlMatcher < CapybaraPage::Page
      set_url_matcher '/foo'
    end
  ...
  context 'with an implicit matcher' do
    class PageWithImplicitUrlMatcher < CapybaraPage::Page
      set_url '/foo'
    end
  ...
  context 'with a parameterized URL matcher' do
    class PageWithParameterizedUrlMatcher < CapybaraPage::Page
  ...
  describe 'with a regexp matcher' do
    class PageWithRegexpUrlMatcher < CapybaraPage::Page
  ...
  it 'should expose the page title' do
    expect(CapybaraPage::Page.new).to respond_to :title
  end
